...
namespace JGEmulatorApp
{
    ...
    public class ThreeBitByteDisplayControl : Control
    {
        private byte _value;
        ...
        public ThreeBitByteDisplayControl()
        {
        ...
        {
            int lightDiameter = Math.Min(Width / 3, Height);
            ...
            for (int i = 0; i < 3; i++)
            {
                bool isOn = (_value & (1 << i)) != 0; // Adjusted to check the correct bit
                Image lightImage = isOn ? yellowLight : grayLight;
